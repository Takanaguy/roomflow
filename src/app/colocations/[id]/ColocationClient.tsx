 ...
 * action (retirer un membre) partent d'un gestionnaire de clic, pas d'un
 * effect - ce n'est plus le meme cas de figure pour le linter.
 */
export default function ColocationClient({ initial }: { initial: ColocationDetail }) {
  ...
  return (
    <main className="mx-auto max-w-2xl px-6 py-16">
      ...
      <div className="mt-6 flex items-center gap-2 rounded-md border border-zinc-200 px-4 py-3">
